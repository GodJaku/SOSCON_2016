...
struct Property__object : ::uObject
{
    ...
    void OnAddListener(::uDelegate* listener) { Property__object__OnAddListener(this, listener); }
    ::uObject* OnGet() { return (((Property__object__uType*)this->__obj_type)->__fp_OnGet)(this); }
    void OnRemoveListener(::uDelegate* listener) { Property__object__OnRemoveListener(this, listener); }
