...
#ifndef __APP_UNO_COLLECTIONS_I_LIST__FUSE_TRIGGERS_ACTIONS_TRIGGER_ACTION_H__
#define __APP_UNO_COLLECTIONS_I_LIST__FUSE_TRIGGERS_ACTIONS_TRIGGER_ACTION_H__
...
struct IList__Fuse_Triggers_Actions_TriggerAction
{
};
