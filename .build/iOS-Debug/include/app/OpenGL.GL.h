// This file was generated based on '/usr/local/share/uno/Packages/UnoCore/0.13.2/Source/OpenGL/$.uno'.
...
int GL__GetInteger(::uStatic* __this, int name_);
::app::Uno::Int4 GL__GetInteger_1(::uStatic* __this, int name_);
...
void GL__TexImage2D(::uStatic* __this, int target_, int level_, int internalFormat_, int width_, int height_, int border_, int format_, int type_, void* data_);
void GL__TexImage2D_1(::uStatic* __this, int target_, int level_, int internalFormat_, int width_, int height_, int border_, int format_, int type_, ::app::Uno::Buffer* data_);
