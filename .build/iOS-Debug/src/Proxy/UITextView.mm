...
- (id<UITextViewDelegate>) delegate
{
    ...
    return uObjC::Lifetime::GetNativeHandle((::uObject *)__return, ::app::iOS::UIKit::IUITextViewDelegate__typeof());
}
...
{
    uObjC_PROXY_FUNCTION_PROLOGUE
    __this->setDelegate_1(uObjC::Lifetime::GetUnoObject(delegate, ::app::iOS::UIKit::Interop::IUITextViewDelegate__typeof()));
}
...
{
    uObjC_PROXY_FUNCTION_PROLOGUE
    ::app::iOS::UIKit::UIEdgeInsets __return = __this->textContainerInset();
...
{
    uObjC_PROXY_FUNCTION_PROLOGUE
    __this->setTextContainerInset(uObjC::Struct::ToUno_UIEdgeInsets(textContainerInset, ::app::iOS::UIKit::UIEdgeInsets()));
}
