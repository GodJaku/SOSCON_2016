// This file was generated based on '/usr/local/share/uno/Packages/UnoCore/0.13.2/Targets/CPlusPlus/Source/Uno/ObjectModel.cpp'.
...
namespace app { namespace Fuse { namespace Camera { struct iOSCameraHelper__uType; iOSCameraHelper__uType* iOSCameraHelper__typeof(); } } }
namespace app { namespace Fuse { namespace Camera { struct iOSCameraImpl__uType; iOSCameraImpl__uType* iOSCameraImpl__typeof(); } } }
namespace app { namespace Fuse { namespace Camera { struct iOSCameraImpl_TakePictureTask__uType; iOSCameraImpl_TakePictureTask__uType* iOSCameraImpl_TakePictureTask__typeof(); } } }
namespace app { namespace Fuse { namespace Camera { struct PictureResult__uType; PictureResult__uType* PictureResult__typeof(); } } }
namespace app { namespace Fuse { namespace Camera { struct TakePictureHelpers__uType; TakePictureHelpers__uType* TakePictureHelpers__typeof(); } } }
...
namespace app { namespace Fuse { namespace Controls { struct BottomFrameBackground__uType; BottomFrameBackground__uType* BottomFrameBackground__typeof(); } } }
...
namespace app { namespace Fuse { namespace Controls { struct EdgeNavigator__uType; EdgeNavigator__uType* EdgeNavigator__typeof(); } } }
...
namespace app { namespace Fuse { namespace Controls { struct StatusBarBackground__uType; StatusBarBackground__uType* StatusBarBackground__typeof(); } } }
...
namespace app { namespace Fuse { namespace Controls { struct TopFrameBackground__uType; TopFrameBackground__uType* TopFrameBackground__typeof(); } } }
...
namespace app { namespace Fuse { namespace Gestures { struct Tapped__uType; Tapped__uType* Tapped__typeof(); } } }
namespace app { namespace Fuse { namespace Gestures { struct TappedArgs__uType; TappedArgs__uType* TappedArgs__typeof(); } } }
...
namespace app { namespace Fuse { namespace Internal { struct Blender__Fuse_Node__uType; Blender__Fuse_Node__uType* Blender__Fuse_Node__typeof(); } } }
...
namespace app { namespace Fuse { namespace iOS { namespace Controls { struct Button__uType; Button__uType* Button__typeof(); } } } }
namespace app { namespace Fuse { namespace iOS { namespace Controls { struct Circle__uType; Circle__uType* Circle__typeof(); } } } }
namespace app { namespace Fuse { namespace iOS { namespace Controls { struct Control__Fuse_Controls_Button__uType; Control__Fuse_Controls_Button__uType* Control__Fuse_Controls_Button__typeof(); } } } }
namespace app { namespace Fuse { namespace iOS { namespace Controls { struct Control__Fuse_Controls_Circle__uType; Control__Fuse_Controls_Circle__uType* Control__Fuse_Controls_Circle__typeof(); } } } }
namespace app { namespace Fuse { namespace iOS { namespace Controls { struct Control__Fuse_Controls_Image__uType; Control__Fuse_Controls_Image__uType* Control__Fuse_Controls_Image__typeof(); } } } }
namespace app { namespace Fuse { namespace iOS { namespace Controls { struct Control__Fuse_Controls_Rectangle__uType; Control__Fuse_Controls_Rectangle__uType* Control__Fuse_Controls_Rectangle__typeof(); } } } }
namespace app { namespace Fuse { namespace iOS { namespace Controls { struct Control__Fuse_Controls_Slider__uType; Control__Fuse_Controls_Slider__uType* Control__Fuse_Controls_Slider__typeof(); } } } }
namespace app { namespace Fuse { namespace iOS { namespace Controls { struct Control__Fuse_Controls_Switch__uType; Control__Fuse_Controls_Switch__uType* Control__Fuse_Controls_Switch__typeof(); } } } }
namespace app { namespace Fuse { namespace iOS { namespace Controls { struct Control__Fuse_Controls_TextBlock__uType; Control__Fuse_Controls_TextBlock__uType* Control__Fuse_Controls_TextBlock__typeof(); } } } }
namespace app { namespace Fuse { namespace iOS { namespace Controls { struct Control__Fuse_Controls_TextInput__uType; Control__Fuse_Controls_TextInput__uType* Control__Fuse_Controls_TextInput__typeof(); } } } }
namespace app { namespace Fuse { namespace iOS { namespace Controls { struct Control__Fuse_Controls_WebView__uType; Control__Fuse_Controls_WebView__uType* Control__Fuse_Controls_WebView__typeof(); } } } }
namespace app { namespace Fuse { namespace iOS { namespace Controls { struct ControlProperties__uType; ControlProperties__uType* ControlProperties__typeof(); } } } }
namespace app { namespace Fuse { namespace iOS { namespace Controls { struct Element__uType; Element__uType* Element__typeof(); } } } }
namespace app { namespace Fuse { namespace iOS { namespace Controls { struct Image__uType; Image__uType* Image__typeof(); } } } }
namespace app { namespace Fuse { namespace iOS { namespace Controls { struct ImageCache__uType; ImageCache__uType* ImageCache__typeof(); } } } }
namespace app { namespace Fuse { namespace iOS { namespace Controls { struct MapView__uType; MapView__uType* MapView__typeof(); } } } }
namespace app { namespace Fuse { namespace iOS { namespace Controls { struct MultilineTextInput__uType; MultilineTextInput__uType* MultilineTextInput__typeof(); } } } }
namespace app { namespace Fuse { namespace iOS { namespace Controls { struct Rectangle__uType; Rectangle__uType* Rectangle__typeof(); } } } }
namespace app { namespace Fuse { namespace iOS { namespace Controls { struct Shape__Fuse_Controls_Circle__uType; Shape__Fuse_Controls_Circle__uType* Shape__Fuse_Controls_Circle__typeof(); } } } }
namespace app { namespace Fuse { namespace iOS { namespace Controls { struct Shape__Fuse_Controls_Rectangle__uType; Shape__Fuse_Controls_Rectangle__uType* Shape__Fuse_Controls_Rectangle__typeof(); } } } }
namespace app { namespace Fuse { namespace iOS { namespace Controls { struct SingleLineTextInput__uType; SingleLineTextInput__uType* SingleLineTextInput__typeof(); } } } }
namespace app { namespace Fuse { namespace iOS { namespace Controls { struct Slider__uType; Slider__uType* Slider__typeof(); } } } }
namespace app { namespace Fuse { namespace iOS { namespace Controls { struct Switch__uType; Switch__uType* Switch__typeof(); } } } }
namespace app { namespace Fuse { namespace iOS { namespace Controls { struct TextBlock__uType; TextBlock__uType* TextBlock__typeof(); } } } }
namespace app { namespace Fuse { namespace iOS { namespace Controls { struct TextInput__uType; TextInput__uType* TextInput__typeof(); } } } }
namespace app { namespace Fuse { namespace iOS { namespace Controls { struct ViewContainer__uType; ViewContainer__uType* ViewContainer__typeof(); } } } }
namespace app { namespace Fuse { namespace iOS { namespace Controls { struct WebView__uType; WebView__uType* WebView__typeof(); } } } }
namespace app { namespace Fuse { namespace iOS { namespace NativeViews { struct ContentControl__uType; ContentControl__uType* ContentControl__typeof(); } } } }
namespace app { namespace Fuse { namespace iOS { namespace NativeViews { struct GenericNativeView__uType; GenericNativeView__uType* GenericNativeView__typeof(); } } } }
namespace app { namespace Fuse { namespace iOS { namespace NativeViews { struct GraphicsView__uType; GraphicsView__uType* GraphicsView__typeof(); } } } }
namespace app { namespace Fuse { namespace iOS { namespace NativeViews { struct LeafNativeView__uType; LeafNativeView__uType* LeafNativeView__typeof(); } } } }
namespace app { namespace Fuse { namespace iOS { namespace NativeViews { struct NativeView__uType; NativeView__uType* NativeView__typeof(); } } } }
namespace app { namespace Fuse { namespace iOS { namespace NativeViews { struct NativeViewHost__uType; NativeViewHost__uType* NativeViewHost__typeof(); } } } }
namespace app { namespace Fuse { namespace iOS { namespace NativeViews { struct Panel__uType; Panel__uType* Panel__typeof(); } } } }
namespace app { namespace Fuse { namespace iOS { namespace NativeViews { struct ParentNativeView__Fuse_Controls_ContentControl__uType; ParentNativeView__Fuse_Controls_ContentControl__uType* ParentNativeView__Fuse_Controls_ContentControl__typeof(); } } } }
namespace app { namespace Fuse { namespace iOS { namespace NativeViews { struct ParentNativeView__Fuse_Controls_GraphicsView__uType; ParentNativeView__Fuse_Controls_GraphicsView__uType* ParentNativeView__Fuse_Controls_GraphicsView__typeof(); } } } }
namespace app { namespace Fuse { namespace iOS { namespace NativeViews { struct ParentNativeView__Fuse_Controls_NativeViewHost__uType; ParentNativeView__Fuse_Controls_NativeViewHost__uType* ParentNativeView__Fuse_Controls_NativeViewHost__typeof(); } } } }
namespace app { namespace Fuse { namespace iOS { namespace NativeViews { struct ParentNativeView__Fuse_Controls_Panel__uType; ParentNativeView__Fuse_Controls_Panel__uType* ParentNativeView__Fuse_Controls_Panel__typeof(); } } } }
namespace app { namespace Fuse { namespace iOS { namespace NativeViews { struct ParentNativeView__Fuse_Controls_ScrollView__uType; ParentNativeView__Fuse_Controls_ScrollView__uType* ParentNativeView__Fuse_Controls_ScrollView__typeof(); } } } }
namespace app { namespace Fuse { namespace iOS { namespace NativeViews { struct ScrollView__uType; ScrollView__uType* ScrollView__typeof(); } } } }
namespace app { namespace Fuse { namespace iOS { struct Blitter__uType; Blitter__uType* Blitter__typeof(); } } }
namespace app { namespace Fuse { namespace iOS { struct ControlEvent__uType; ControlEvent__uType* ControlEvent__typeof(); } } }
namespace app { namespace Fuse { namespace iOS { struct FontCache__uType; FontCache__uType* FontCache__typeof(); } } }
namespace app { namespace Fuse { namespace iOS { struct Helpers__uType; Helpers__uType* Helpers__typeof(); } } }
namespace app { namespace Fuse { namespace iOS { struct InputDispatch__uType; InputDispatch__uType* InputDispatch__typeof(); } } }
namespace app { namespace Fuse { namespace iOS { struct InputDispatch_TouchEvents__uType; InputDispatch_TouchEvents__uType* InputDispatch_TouchEvents__typeof(); } } }
namespace app { namespace Fuse { namespace iOS { struct iOSBindingView__uType; iOSBindingView__uType* iOSBindingView__typeof(); } } }
namespace app { namespace Fuse { namespace iOS { struct iOSDeviceInterop__uType; iOSDeviceInterop__uType* iOSDeviceInterop__typeof(); } } }
namespace app { namespace Fuse { namespace iOS { struct iOSExtensions__uType; iOSExtensions__uType* iOSExtensions__typeof(); } } }
namespace app { namespace Fuse { namespace iOS { struct iOSInterop__uType; iOSInterop__uType* iOSInterop__typeof(); } } }
namespace app { namespace Fuse { namespace iOS { struct NativeStyle__uType; NativeStyle__uType* NativeStyle__typeof(); } } }
...
namespace app { namespace Fuse { namespace iOS { struct NativeTemplate__uType; NativeTemplate__uType* NativeTemplate__typeof(); } } }
namespace app { namespace Fuse { namespace iOS { struct RootView__uType; RootView__uType* RootView__typeof(); } } }
...
namespace app { namespace Fuse { namespace iOS { struct Transform__uType; Transform__uType* Transform__typeof(); } } }
namespace app { namespace Fuse { namespace iOS { struct UIControlCallback__uType; UIControlCallback__uType* UIControlCallback__typeof(); } } }
...
namespace app { namespace Fuse { namespace Reactive { namespace FuseJS { struct Base64__uType; Base64__uType* Base64__typeof(); } } } }
...
namespace app { namespace Fuse { namespace Reactive { struct DataBinding__object__uType; DataBinding__object__uType* DataBinding__object__typeof(); } } }
...
namespace app { namespace Fuse { namespace Scripting { namespace JavaScriptCore { struct Array__uType; Array__uType* Array__typeof(); } } } }
namespace app { namespace Fuse { namespace Scripting { namespace JavaScriptCore { struct CallbackExceptionHandler__uType; CallbackExceptionHandler__uType* CallbackExceptionHandler__typeof(); } } } }
namespace app { namespace Fuse { namespace Scripting { namespace JavaScriptCore { struct CallbackWrapper__uType; CallbackWrapper__uType* CallbackWrapper__typeof(); } } } }
namespace app { namespace Fuse { namespace Scripting { namespace JavaScriptCore { struct Context__uType; Context__uType* Context__typeof(); } } } }
namespace app { namespace Fuse { namespace Scripting { namespace JavaScriptCore { struct Evaluator__uType; Evaluator__uType* Evaluator__typeof(); } } } }
namespace app { namespace Fuse { namespace Scripting { namespace JavaScriptCore { struct ExceptionHandler__uType; ExceptionHandler__uType* ExceptionHandler__typeof(); } } } }
namespace app { namespace Fuse { namespace Scripting { namespace JavaScriptCore { struct Function__uType; Function__uType* Function__typeof(); } } } }
namespace app { namespace Fuse { namespace Scripting { namespace JavaScriptCore { struct Object__uType; Object__uType* Object__typeof(); } } } }
namespace app { namespace Fuse { namespace Scripting { namespace JavaScriptCore { struct ObjectMarshaller__uType; ObjectMarshaller__uType* ObjectMarshaller__typeof(); } } } }
...
namespace app { namespace Fuse { namespace Triggers { namespace Actions { struct Set__Fuse_Node__uType; Set__Fuse_Node__uType* Set__Fuse_Node__typeof(); } } } }
...
namespace app { namespace Fuse { struct StyleProperty__Fuse_Controls_Control__float4__uType; StyleProperty__Fuse_Controls_Control__float4__uType* StyleProperty__Fuse_Controls_Control__float4__typeof(); } }
...
namespace app { namespace Fuse { struct StyleProperty__Fuse_iOS_Controls_Button__float4__uType; StyleProperty__Fuse_iOS_Controls_Button__float4__uType* StyleProperty__Fuse_iOS_Controls_Button__float4__typeof(); } }
...
namespace app { namespace Fuse { struct UpdateDispatcher__uType; UpdateDispatcher__uType* UpdateDispatcher__typeof(); } }
...
namespace app { namespace iOS { namespace AudioToolbox { struct Functions__uType; Functions__uType* Functions__typeof(); } } }
namespace app { namespace iOS { namespace CoreFoundation { struct CFStringRef__uType; CFStringRef__uType* CFStringRef__typeof(); } } }
namespace app { namespace iOS { namespace CoreGraphics { struct CGAffineTransform__uType; CGAffineTransform__uType* CGAffineTransform__typeof(); } } }
namespace app { namespace iOS { namespace CoreGraphics { struct CGColorRef__uType; CGColorRef__uType* CGColorRef__typeof(); } } }
namespace app { namespace iOS { namespace CoreGraphics { struct CGColorSpaceRef__uType; CGColorSpaceRef__uType* CGColorSpaceRef__typeof(); } } }
namespace app { namespace iOS { namespace CoreGraphics { struct CGContextRef__uType; CGContextRef__uType* CGContextRef__typeof(); } } }
namespace app { namespace iOS { namespace CoreGraphics { struct CGDataProviderRef__uType; CGDataProviderRef__uType* CGDataProviderRef__typeof(); } } }
namespace app { namespace iOS { namespace CoreGraphics { struct CGFontRef__uType; CGFontRef__uType* CGFontRef__typeof(); } } }
namespace app { namespace iOS { namespace CoreGraphics { struct CGPathRef__uType; CGPathRef__uType* CGPathRef__typeof(); } } }
namespace app { namespace iOS { namespace CoreGraphics { struct CGPoint__uType; CGPoint__uType* CGPoint__typeof(); } } }
namespace app { namespace iOS { namespace CoreGraphics { struct CGRect__uType; CGRect__uType* CGRect__typeof(); } } }
namespace app { namespace iOS { namespace CoreGraphics { struct CGSize__uType; CGSize__uType* CGSize__typeof(); } } }
namespace app { namespace iOS { namespace CoreGraphics { struct Functions__uType; Functions__uType* Functions__typeof(); } } }
namespace app { namespace iOS { namespace CoreImage { struct CIImage__uType; CIImage__uType* CIImage__typeof(); } } }
namespace app { namespace iOS { namespace Foundation { namespace Interop { struct INSCopying__uType; INSCopying__uType* INSCopying__typeof(); } } } }
namespace app { namespace iOS { namespace Foundation { struct _NSRange__uType; _NSRange__uType* _NSRange__typeof(); } } }
namespace app { namespace iOS { namespace Foundation { struct NSArray__uType; NSArray__uType* NSArray__typeof(); } } }
namespace app { namespace iOS { namespace Foundation { struct NSAttributedString__uType; NSAttributedString__uType* NSAttributedString__typeof(); } } }
namespace app { namespace iOS { namespace Foundation { struct NSBundle__uType; NSBundle__uType* NSBundle__typeof(); } } }
namespace app { namespace iOS { namespace Foundation { struct NSDictionary__uType; NSDictionary__uType* NSDictionary__typeof(); } } }
namespace app { namespace iOS { namespace Foundation { struct NSError__uType; NSError__uType* NSError__typeof(); } } }
namespace app { namespace iOS { namespace Foundation { struct NSMutableArray__uType; NSMutableArray__uType* NSMutableArray__typeof(); } } }
namespace app { namespace iOS { namespace Foundation { struct NSMutableAttributedString__uType; NSMutableAttributedString__uType* NSMutableAttributedString__typeof(); } } }
namespace app { namespace iOS { namespace Foundation { struct NSMutableDictionary__uType; NSMutableDictionary__uType* NSMutableDictionary__typeof(); } } }
namespace app { namespace iOS { namespace Foundation { struct NSNumber__uType; NSNumber__uType* NSNumber__typeof(); } } }
namespace app { namespace iOS { namespace Foundation { struct NSObject__uType; NSObject__uType* NSObject__typeof(); } } }
namespace app { namespace iOS { namespace Foundation { struct NSSet__uType; NSSet__uType* NSSet__typeof(); } } }
namespace app { namespace iOS { namespace Foundation { struct NSString__uType; NSString__uType* NSString__typeof(); } } }
namespace app { namespace iOS { namespace Foundation { struct NSStringExtensions__uType; NSStringExtensions__uType* NSStringExtensions__typeof(); } } }
namespace app { namespace iOS { namespace Foundation { struct NSURL__uType; NSURL__uType* NSURL__typeof(); } } }
namespace app { namespace iOS { namespace Foundation { struct NSURLCache__uType; NSURLCache__uType* NSURLCache__typeof(); } } }
namespace app { namespace iOS { namespace Foundation { struct NSURLRequest__uType; NSURLRequest__uType* NSURLRequest__typeof(); } } }
namespace app { namespace iOS { namespace Foundation { struct NSValue__uType; NSValue__uType* NSValue__typeof(); } } }
namespace app { namespace iOS { namespace GLKit { struct GLKView__uType; GLKView__uType* GLKView__typeof(); } } }
namespace app { namespace iOS { namespace JavaScriptCore { struct JSContext__uType; JSContext__uType* JSContext__typeof(); } } }
namespace app { namespace iOS { namespace JavaScriptCore { struct JSValue__uType; JSValue__uType* JSValue__typeof(); } } }
namespace app { namespace iOS { namespace MapKit { struct MKMapView__uType; MKMapView__uType* MKMapView__typeof(); } } }
namespace app { namespace iOS { namespace OpenGLES { struct EAGLContext__uType; EAGLContext__uType* EAGLContext__typeof(); } } }
namespace app { namespace iOS { namespace QuartzCore { struct CALayer__uType; CALayer__uType* CALayer__typeof(); } } }
namespace app { namespace iOS { namespace QuartzCore { struct CAShapeLayer__uType; CAShapeLayer__uType* CAShapeLayer__typeof(); } } }
namespace app { namespace iOS { namespace QuartzCore { struct CATransform3D__uType; CATransform3D__uType* CATransform3D__typeof(); } } }
namespace app { namespace iOS { namespace UIKit { namespace Interop { struct IUIImagePickerControllerDelegate__uType; IUIImagePickerControllerDelegate__uType* IUIImagePickerControllerDelegate__typeof(); } } } }
namespace app { namespace iOS { namespace UIKit { namespace Interop { struct IUIKeyInput__uType; IUIKeyInput__uType* IUIKeyInput__typeof(); } } } }
namespace app { namespace iOS { namespace UIKit { namespace Interop { struct IUIScrollViewDelegate__uType; IUIScrollViewDelegate__uType* IUIScrollViewDelegate__typeof(); } } } }
namespace app { namespace iOS { namespace UIKit { namespace Interop { struct IUITextInput__uType; IUITextInput__uType* IUITextInput__typeof(); } } } }
namespace app { namespace iOS { namespace UIKit { namespace Interop { struct IUITextInputDelegate__uType; IUITextInputDelegate__uType* IUITextInputDelegate__typeof(); } } } }
namespace app { namespace iOS { namespace UIKit { namespace Interop { struct IUITextInputTokenizer__uType; IUITextInputTokenizer__uType* IUITextInputTokenizer__typeof(); } } } }
namespace app { namespace iOS { namespace UIKit { namespace Interop { struct IUITextInputTraits__uType; IUITextInputTraits__uType* IUITextInputTraits__typeof(); } } } }
namespace app { namespace iOS { namespace UIKit { namespace Interop { struct IUITextViewDelegate__uType; IUITextViewDelegate__uType* IUITextViewDelegate__typeof(); } } } }
namespace app { namespace iOS { namespace UIKit { struct Functions__uType; Functions__uType* Functions__typeof(); } } }
namespace app { namespace iOS { namespace UIKit { struct NSLayoutManager__uType; NSLayoutManager__uType* NSLayoutManager__typeof(); } } }
namespace app { namespace iOS { namespace UIKit { struct NSMutableParagraphStyle__uType; NSMutableParagraphStyle__uType* NSMutableParagraphStyle__typeof(); } } }
namespace app { namespace iOS { namespace UIKit { struct NSParagraphStyle__uType; NSParagraphStyle__uType* NSParagraphStyle__typeof(); } } }
namespace app { namespace iOS { namespace UIKit { struct NSTextAttachment__uType; NSTextAttachment__uType* NSTextAttachment__typeof(); } } }
namespace app { namespace iOS { namespace UIKit { struct NSTextContainer__uType; NSTextContainer__uType* NSTextContainer__typeof(); } } }
namespace app { namespace iOS { namespace UIKit { struct NSTextStorage__uType; NSTextStorage__uType* NSTextStorage__typeof(); } } }
namespace app { namespace iOS { namespace UIKit { struct UIApplication__uType; UIApplication__uType* UIApplication__typeof(); } } }
namespace app { namespace iOS { namespace UIKit { struct UIBezierPath__uType; UIBezierPath__uType* UIBezierPath__typeof(); } } }
namespace app { namespace iOS { namespace UIKit { struct UIButton__uType; UIButton__uType* UIButton__typeof(); } } }
namespace app { namespace iOS { namespace UIKit { struct UIColor__uType; UIColor__uType* UIColor__typeof(); } } }
namespace app { namespace iOS { namespace UIKit { struct UIControl__uType; UIControl__uType* UIControl__typeof(); } } }
namespace app { namespace iOS { namespace UIKit { struct UIEdgeInsets__uType; UIEdgeInsets__uType* UIEdgeInsets__typeof(); } } }
namespace app { namespace iOS { namespace UIKit { struct UIEvent__uType; UIEvent__uType* UIEvent__typeof(); } } }
namespace app { namespace iOS { namespace UIKit { struct UIFont__uType; UIFont__uType* UIFont__typeof(); } } }
namespace app { namespace iOS { namespace UIKit { struct UIImage__uType; UIImage__uType* UIImage__typeof(); } } }
namespace app { namespace iOS { namespace UIKit { struct UIImagePickerController__uType; UIImagePickerController__uType* UIImagePickerController__typeof(); } } }
namespace app { namespace iOS { namespace UIKit { struct UIImageView__uType; UIImageView__uType* UIImageView__typeof(); } } }
namespace app { namespace iOS { namespace UIKit { struct UILabel__uType; UILabel__uType* UILabel__typeof(); } } }
namespace app { namespace iOS { namespace UIKit { struct UINavigationController__uType; UINavigationController__uType* UINavigationController__typeof(); } } }
namespace app { namespace iOS { namespace UIKit { struct UIResponder__uType; UIResponder__uType* UIResponder__typeof(); } } }
namespace app { namespace iOS { namespace UIKit { struct UIScrollView__uType; UIScrollView__uType* UIScrollView__typeof(); } } }
namespace app { namespace iOS { namespace UIKit { struct UISlider__uType; UISlider__uType* UISlider__typeof(); } } }
namespace app { namespace iOS { namespace UIKit { struct UISwitch__uType; UISwitch__uType* UISwitch__typeof(); } } }
namespace app { namespace iOS { namespace UIKit { struct UITextField__uType; UITextField__uType* UITextField__typeof(); } } }
namespace app { namespace iOS { namespace UIKit { struct UITextPosition__uType; UITextPosition__uType* UITextPosition__typeof(); } } }
namespace app { namespace iOS { namespace UIKit { struct UITextRange__uType; UITextRange__uType* UITextRange__typeof(); } } }
namespace app { namespace iOS { namespace UIKit { struct UITextView__uType; UITextView__uType* UITextView__typeof(); } } }
namespace app { namespace iOS { namespace UIKit { struct UITouch__uType; UITouch__uType* UITouch__typeof(); } } }
namespace app { namespace iOS { namespace UIKit { struct UIView__uType; UIView__uType* UIView__typeof(); } } }
namespace app { namespace iOS { namespace UIKit { struct UIViewController__uType; UIViewController__uType* UIViewController__typeof(); } } }
namespace app { namespace iOS { namespace UIKit { struct UIWindow__uType; UIWindow__uType* UIWindow__typeof(); } } }
namespace app { namespace iOS { namespace WebKit { struct WKNavigation__uType; WKNavigation__uType* WKNavigation__typeof(); } } }
namespace app { namespace iOS { namespace WebKit { struct WKWebView__uType; WKWebView__uType* WKWebView__typeof(); } } }
namespace app { namespace ObjC { struct ID__uType; ID__uType* ID__typeof(); } }
namespace app { namespace ObjC { struct Object__uType; Object__uType* Object__typeof(); } }
namespace app { namespace ObjC { struct Selector__uType; Selector__uType* Selector__typeof(); } }
...
namespace app { namespace Uno { namespace Collections { struct Dictionary__iOS_Foundation_INSCopying__ObjC_ID__uType; Dictionary__iOS_Foundation_INSCopying__ObjC_ID__uType* Dictionary__iOS_Foundation_INSCopying__ObjC_ID__typeof(); } } }
namespace app { namespace Uno { namespace Collections { struct Dictionary__iOS_UIKit_UIControl__Fuse_Node__uType; Dictionary__iOS_UIKit_UIControl__Fuse_Node__uType* Dictionary__iOS_UIKit_UIControl__Fuse_Node__typeof(); } } }
...
namespace app { namespace Uno { namespace Collections { struct Dictionary__Uno_UX_FileSource__iOS_UIKit_UIImage__uType; Dictionary__Uno_UX_FileSource__iOS_UIKit_UIImage__uType* Dictionary__Uno_UX_FileSource__iOS_UIKit_UIImage__typeof(); } } }
...
namespace app { namespace Uno { namespace Collections { struct Dictionary2_Bucket__iOS_Foundation_INSCopying__ObjC_ID__uType; Dictionary2_Bucket__iOS_Foundation_INSCopying__ObjC_ID__uType* Dictionary2_Bucket__iOS_Foundation_INSCopying__ObjC_ID__typeof(); } } }
namespace app { namespace Uno { namespace Collections { struct Dictionary2_Bucket__iOS_UIKit_UIControl__Fuse_Node__uType; Dictionary2_Bucket__iOS_UIKit_UIControl__Fuse_Node__uType* Dictionary2_Bucket__iOS_UIKit_UIControl__Fuse_Node__typeof(); } } }
...
namespace app { namespace Uno { namespace Collections { struct Dictionary2_Bucket__Uno_UX_FileSource__iOS_UIKit_UIImage__uType; Dictionary2_Bucket__Uno_UX_FileSource__iOS_UIKit_UIImage__uType* Dictionary2_Bucket__Uno_UX_FileSource__iOS_UIKit_UIImage__typeof(); } } }
...
namespace app { namespace Uno { namespace Collections { struct Dictionary2_Enumerator__iOS_Foundation_INSCopying__ObjC_ID__uType; Dictionary2_Enumerator__iOS_Foundation_INSCopying__ObjC_ID__uType* Dictionary2_Enumerator__iOS_Foundation_INSCopying__ObjC_ID__typeof(); } } }
...
namespace app { namespace Uno { namespace Collections { struct KeyValuePair__iOS_Foundation_INSCopying__ObjC_ID__uType; KeyValuePair__iOS_Foundation_INSCopying__ObjC_ID__uType* KeyValuePair__iOS_Foundation_INSCopying__ObjC_ID__typeof(); } } }
...
namespace app { namespace Uno { namespace Collections { struct List__byte__uType; List__byte__uType* List__byte__typeof(); } } }
...
namespace app { namespace Uno { namespace Collections { struct List__int4__uType; List__int4__uType* List__int4__typeof(); } } }
namespace app { namespace Uno { namespace Collections { struct List__iOS_QuartzCore_CAShapeLayer__uType; List__iOS_QuartzCore_CAShapeLayer__uType* List__iOS_QuartzCore_CAShapeLayer__typeof(); } } }
...
namespace app { namespace Uno { namespace Compiler { namespace ExportTargetInterop { struct OptionalAttribute__uType; OptionalAttribute__uType* OptionalAttribute__typeof(); } } } }
...
namespace app { namespace Uno { namespace Compiler { struct HideFromCodeCompleterAttribute__uType; HideFromCodeCompleterAttribute__uType* HideFromCodeCompleterAttribute__typeof(); } } }
...
namespace app { namespace Uno { namespace Net { namespace Http { namespace Implementation { struct iOSHttpRequest__uType; iOSHttpRequest__uType* iOSHttpRequest__typeof(); } } } } }
namespace app { namespace Uno { namespace Net { namespace Http { namespace Implementation { struct iOSHttpRequestHandle__uType; iOSHttpRequestHandle__uType* iOSHttpRequestHandle__typeof(); } } } } }
namespace app { namespace Uno { namespace Net { namespace Http { namespace Implementation { struct iOSHttpSharedCache__uType; iOSHttpSharedCache__uType* iOSHttpSharedCache__typeof(); } } } } }
...
namespace app { namespace Uno { namespace Platform { namespace iOS { struct StatusBar__uType; StatusBar__uType* StatusBar__typeof(); } } } }
...
namespace app { namespace Uno { namespace Text { struct Ascii__uType; Ascii__uType* Ascii__typeof(); } } }
...
namespace app { namespace Uno { namespace Text { struct Utf8__uType; Utf8__uType* Utf8__typeof(); } } }
...
namespace app { namespace Uno { namespace UX { struct Property__Fuse_Node__uType; Property__Fuse_Node__uType* Property__Fuse_Node__typeof(); } } }
namespace app { namespace Uno { namespace UX { struct Property__object__uType; Property__object__uType* Property__object__typeof(); } } }
...
namespace app { namespace Uno { namespace UX { struct ValueChangedArgs__object__uType; ValueChangedArgs__object__uType* ValueChangedArgs__object__typeof(); } } }
...
namespace app { struct ArticleView__uType; ArticleView__uType* ArticleView__typeof(); }
namespace app { struct ButtonText__uType; ButtonText__uType* ButtonText__typeof(); }
namespace app { struct DateView__uType; DateView__uType* DateView__typeof(); }
namespace app { struct Divider__uType; Divider__uType* Divider__typeof(); }
namespace app { struct HeaderView__uType; HeaderView__uType* HeaderView__typeof(); }
namespace app { struct MainView__uType; MainView__uType* MainView__typeof(); }
namespace app { struct MainView_Factory__uType; MainView_Factory__uType* MainView_Factory__typeof(); }
namespace app { struct MainView_Factory1__uType; MainView_Factory1__uType* MainView_Factory1__typeof(); }
namespace app { struct MainView_Factory2__uType; MainView_Factory2__uType* MainView_Factory2__typeof(); }
namespace app { struct MainView_Factory3__uType; MainView_Factory3__uType* MainView_Factory3__typeof(); }
namespace app { struct MainView_Fuse_Controls_EdgeNavigator_Fuse_Node_Active_Property__uType; MainView_Fuse_Controls_EdgeNavigator_Fuse_Node_Active_Property__uType* MainView_Fuse_Controls_EdgeNavigator_Fuse_Node_Active_Property__typeof(); }
...
namespace app { struct MainView_Fuse_Elements_Element_float_Width_Property__uType; MainView_Fuse_Elements_Element_float_Width_Property__uType* MainView_Fuse_Elements_Element_float_Width_Property__typeof(); }
namespace app { struct MainView_Fuse_Reactive_Each_object_Items_Property__uType; MainView_Fuse_Reactive_Each_object_Items_Property__uType* MainView_Fuse_Reactive_Each_object_Items_Property__typeof(); }
namespace app { struct MainView_Fuse_Rotation_float_Degrees_Property__uType; MainView_Fuse_Rotation_float_Degrees_Property__uType* MainView_Fuse_Rotation_float_Degrees_Property__typeof(); }
namespace app { struct MainView_Fuse_Translation_float_X_Property__uType; MainView_Fuse_Translation_float_X_Property__uType* MainView_Fuse_Translation_float_X_Property__typeof(); }
namespace app { struct MainView_Fuse_Translation_float_Y_Property__uType; MainView_Fuse_Translation_float_Y_Property__uType* MainView_Fuse_Translation_float_Y_Property__typeof(); }
namespace app { struct MenuLabel__uType; MenuLabel__uType* MenuLabel__typeof(); }
namespace app { struct Relations__uType; Relations__uType* Relations__typeof(); }
namespace app { struct Sidebar__uType; Sidebar__uType* Sidebar__typeof(); }
namespace app { struct SidebarIcon__uType; SidebarIcon__uType* SidebarIcon__typeof(); }
namespace app { struct Stats__uType; Stats__uType* Stats__typeof(); }
namespace app { struct UserName__uType; UserName__uType* UserName__typeof(); }

static void uInitTypeObjects()
{
    static uType*(*functions[])() =
    {
        (::uType*(*)())&::app::ArticleView__typeof,
        (::uType*(*)())&::app::ButtonText__typeof,
        (::uType*(*)())&::app::DateView__typeof,
        (::uType*(*)())&::app::Divider__typeof,
        ...
        (::uType*(*)())&::app::Fuse::Camera::iOSCameraHelper__typeof,
        (::uType*(*)())&::app::Fuse::Camera::iOSCameraImpl__typeof,
        (::uType*(*)())&::app::Fuse::Camera::iOSCameraImpl_TakePictureTask__typeof,
        (::uType*(*)())&::app::Fuse::Camera::PictureResult__typeof,
        (::uType*(*)())&::app::Fuse::Camera::TakePictureHelpers__typeof,
        ...
        (::uType*(*)())&::app::Fuse::Controls::BottomFrameBackground__typeof,
        ...
        (::uType*(*)())&::app::Fuse::Controls::EdgeNavigator__typeof,
        ...
        (::uType*(*)())&::app::Fuse::Controls::StatusBarBackground__typeof,
        ...
        (::uType*(*)())&::app::Fuse::Controls::TopFrameBackground__typeof,
        ...
        (::uType*(*)())&::app::Fuse::Gestures::Tapped__typeof,
        (::uType*(*)())&::app::Fuse::Gestures::TappedArgs__typeof,
        ...
        (::uType*(*)())&::app::Fuse::Internal::Blender__Fuse_Node__typeof,
        ...
        (::uType*(*)())&::app::Fuse::iOS::ControlEvent__typeof,
        (::uType*(*)())&::app::Fuse::iOS::Controls::Button__typeof,
        (::uType*(*)())&::app::Fuse::iOS::Controls::Circle__typeof,
        (::uType*(*)())&::app::Fuse::iOS::Controls::Control__Fuse_Controls_Button__typeof,
        (::uType*(*)())&::app::Fuse::iOS::Controls::Control__Fuse_Controls_Circle__typeof,
        (::uType*(*)())&::app::Fuse::iOS::Controls::Control__Fuse_Controls_Image__typeof,
        (::uType*(*)())&::app::Fuse::iOS::Controls::Control__Fuse_Controls_Rectangle__typeof,
        (::uType*(*)())&::app::Fuse::iOS::Controls::Control__Fuse_Controls_Slider__typeof,
        (::uType*(*)())&::app::Fuse::iOS::Controls::Control__Fuse_Controls_Switch__typeof,
        (::uType*(*)())&::app::Fuse::iOS::Controls::Control__Fuse_Controls_TextBlock__typeof,
        (::uType*(*)())&::app::Fuse::iOS::Controls::Control__Fuse_Controls_TextInput__typeof,
        (::uType*(*)())&::app::Fuse::iOS::Controls::Control__Fuse_Controls_WebView__typeof,
        (::uType*(*)())&::app::Fuse::iOS::Controls::ControlProperties__typeof,
        (::uType*(*)())&::app::Fuse::iOS::Controls::Element__typeof,
        (::uType*(*)())&::app::Fuse::iOS::Controls::Image__typeof,
        (::uType*(*)())&::app::Fuse::iOS::Controls::ImageCache__typeof,
        (::uType*(*)())&::app::Fuse::iOS::Controls::MapView__typeof,
        (::uType*(*)())&::app::Fuse::iOS::Controls::MultilineTextInput__typeof,
        (::uType*(*)())&::app::Fuse::iOS::Controls::Rectangle__typeof,
        (::uType*(*)())&::app::Fuse::iOS::Controls::Shape__Fuse_Controls_Circle__typeof,
        (::uType*(*)())&::app::Fuse::iOS::Controls::Shape__Fuse_Controls_Rectangle__typeof,
        (::uType*(*)())&::app::Fuse::iOS::Controls::SingleLineTextInput__typeof,
        (::uType*(*)())&::app::Fuse::iOS::Controls::Slider__typeof,
        (::uType*(*)())&::app::Fuse::iOS::Controls::Switch__typeof,
        (::uType*(*)())&::app::Fuse::iOS::Controls::TextBlock__typeof,
        (::uType*(*)())&::app::Fuse::iOS::Controls::TextInput__typeof,
        (::uType*(*)())&::app::Fuse::iOS::Controls::ViewContainer__typeof,
        (::uType*(*)())&::app::Fuse::iOS::Controls::WebView__typeof,
        (::uType*(*)())&::app::Fuse::iOS::FontCache__typeof,
        (::uType*(*)())&::app::Fuse::iOS::Helpers__typeof,
        (::uType*(*)())&::app::Fuse::iOS::InputDispatch__typeof,
        (::uType*(*)())&::app::Fuse::iOS::InputDispatch_TouchEvents__typeof,
        (::uType*(*)())&::app::Fuse::iOS::iOSBindingView__typeof,
        (::uType*(*)())&::app::Fuse::iOS::iOSDeviceInterop__typeof,
        (::uType*(*)())&::app::Fuse::iOS::iOSExtensions__typeof,
        (::uType*(*)())&::app::Fuse::iOS::iOSInterop__typeof,
        (::uType*(*)())&::app::Fuse::iOS::NativeStyle__typeof,
        ...
        (::uType*(*)())&::app::Fuse::iOS::NativeTemplate__typeof,
        (::uType*(*)())&::app::Fuse::iOS::NativeViews::ContentControl__typeof,
        (::uType*(*)())&::app::Fuse::iOS::NativeViews::GenericNativeView__typeof,
        (::uType*(*)())&::app::Fuse::iOS::NativeViews::GraphicsView__typeof,
        (::uType*(*)())&::app::Fuse::iOS::NativeViews::LeafNativeView__typeof,
        (::uType*(*)())&::app::Fuse::iOS::NativeViews::NativeView__typeof,
        (::uType*(*)())&::app::Fuse::iOS::NativeViews::NativeViewHost__typeof,
        (::uType*(*)())&::app::Fuse::iOS::NativeViews::Panel__typeof,
        (::uType*(*)())&::app::Fuse::iOS::NativeViews::ParentNativeView__Fuse_Controls_ContentControl__typeof,
        (::uType*(*)())&::app::Fuse::iOS::NativeViews::ParentNativeView__Fuse_Controls_GraphicsView__typeof,
        (::uType*(*)())&::app::Fuse::iOS::NativeViews::ParentNativeView__Fuse_Controls_NativeViewHost__typeof,
        (::uType*(*)())&::app::Fuse::iOS::NativeViews::ParentNativeView__Fuse_Controls_Panel__typeof,
        (::uType*(*)())&::app::Fuse::iOS::NativeViews::ParentNativeView__Fuse_Controls_ScrollView__typeof,
        (::uType*(*)())&::app::Fuse::iOS::NativeViews::ScrollView__typeof,
        (::uType*(*)())&::app::Fuse::iOS::RootView__typeof,
        (::uType*(*)())&::app::Fuse::iOS::StatusBarConfig__typeof,
        (::uType*(*)())&::app::Fuse::iOS::TextRenderer__typeof,
        (::uType*(*)())&::app::Fuse::iOS::Transform__typeof,
        (::uType*(*)())&::app::Fuse::iOS::UIControlCallback__typeof,
        ...
        (::uType*(*)())&::app::Fuse::Reactive::DataBinding__object__typeof,
        ...
        (::uType*(*)())&::app::Fuse::Reactive::FuseJS::Base64__typeof,
        ...
        (::uType*(*)())&::app::Fuse::Scripting::JavaScriptCore::Array__typeof,
        (::uType*(*)())&::app::Fuse::Scripting::JavaScriptCore::CallbackExceptionHandler__typeof,
        (::uType*(*)())&::app::Fuse::Scripting::JavaScriptCore::CallbackWrapper__typeof,
        (::uType*(*)())&::app::Fuse::Scripting::JavaScriptCore::Context__typeof,
        (::uType*(*)())&::app::Fuse::Scripting::JavaScriptCore::Evaluator__typeof,
        (::uType*(*)())&::app::Fuse::Scripting::JavaScriptCore::ExceptionHandler__typeof,
        (::uType*(*)())&::app::Fuse::Scripting::JavaScriptCore::Function__typeof,
        (::uType*(*)())&::app::Fuse::Scripting::JavaScriptCore::Object__typeof,
        (::uType*(*)())&::app::Fuse::Scripting::JavaScriptCore::ObjectMarshaller__typeof,
        ...
        (::uType*(*)())&::app::Fuse::StyleProperty__Fuse_Controls_Control__float4__typeof,
        ...
        (::uType*(*)())&::app::Fuse::StyleProperty__Fuse_iOS_Controls_Button__float4__typeof,
        ...
        (::uType*(*)())&::app::Fuse::Triggers::Actions::Set__Fuse_Node__typeof,
        ...
        (::uType*(*)())&::app::Fuse::UpdateDispatcher__typeof,
        ...
        (::uType*(*)())&::app::HeaderView__typeof,
        (::uType*(*)())&::app::iOS::AudioToolbox::Functions__typeof,
        (::uType*(*)())&::app::iOS::CoreFoundation::CFStringRef__typeof,
        (::uType*(*)())&::app::iOS::CoreGraphics::CGAffineTransform__typeof,
        (::uType*(*)())&::app::iOS::CoreGraphics::CGColorRef__typeof,
        (::uType*(*)())&::app::iOS::CoreGraphics::CGColorSpaceRef__typeof,
        (::uType*(*)())&::app::iOS::CoreGraphics::CGContextRef__typeof,
        (::uType*(*)())&::app::iOS::CoreGraphics::CGDataProviderRef__typeof,
        (::uType*(*)())&::app::iOS::CoreGraphics::CGFontRef__typeof,
        (::uType*(*)())&::app::iOS::CoreGraphics::CGPathRef__typeof,
        (::uType*(*)())&::app::iOS::CoreGraphics::CGPoint__typeof,
        (::uType*(*)())&::app::iOS::CoreGraphics::CGRect__typeof,
        (::uType*(*)())&::app::iOS::CoreGraphics::CGSize__typeof,
        (::uType*(*)())&::app::iOS::CoreGraphics::Functions__typeof,
        (::uType*(*)())&::app::iOS::CoreImage::CIImage__typeof,
        (::uType*(*)())&::app::iOS::Foundation::_NSRange__typeof,
        (::uType*(*)())&::app::iOS::Foundation::Interop::INSCopying__typeof,
        (::uType*(*)())&::app::iOS::Foundation::NSArray__typeof,
        (::uType*(*)())&::app::iOS::Foundation::NSAttributedString__typeof,
        (::uType*(*)())&::app::iOS::Foundation::NSBundle__typeof,
        (::uType*(*)())&::app::iOS::Foundation::NSDictionary__typeof,
        (::uType*(*)())&::app::iOS::Foundation::NSError__typeof,
        (::uType*(*)())&::app::iOS::Foundation::NSMutableArray__typeof,
        (::uType*(*)())&::app::iOS::Foundation::NSMutableAttributedString__typeof,
        (::uType*(*)())&::app::iOS::Foundation::NSMutableDictionary__typeof,
        (::uType*(*)())&::app::iOS::Foundation::NSNumber__typeof,
        (::uType*(*)())&::app::iOS::Foundation::NSObject__typeof,
        (::uType*(*)())&::app::iOS::Foundation::NSSet__typeof,
        (::uType*(*)())&::app::iOS::Foundation::NSString__typeof,
        (::uType*(*)())&::app::iOS::Foundation::NSStringExtensions__typeof,
        (::uType*(*)())&::app::iOS::Foundation::NSURL__typeof,
        (::uType*(*)())&::app::iOS::Foundation::NSURLCache__typeof,
        (::uType*(*)())&::app::iOS::Foundation::NSURLRequest__typeof,
        (::uType*(*)())&::app::iOS::Foundation::NSValue__typeof,
        (::uType*(*)())&::app::iOS::GLKit::GLKView__typeof,
        (::uType*(*)())&::app::iOS::JavaScriptCore::JSContext__typeof,
        (::uType*(*)())&::app::iOS::JavaScriptCore::JSValue__typeof,
        (::uType*(*)())&::app::iOS::MapKit::MKMapView__typeof,
        (::uType*(*)())&::app::iOS::OpenGLES::EAGLContext__typeof,
        (::uType*(*)())&::app::iOS::QuartzCore::CALayer__typeof,
        (::uType*(*)())&::app::iOS::QuartzCore::CAShapeLayer__typeof,
        (::uType*(*)())&::app::iOS::QuartzCore::CATransform3D__typeof,
        (::uType*(*)())&::app::iOS::UIKit::Functions__typeof,
        (::uType*(*)())&::app::iOS::UIKit::Interop::IUIImagePickerControllerDelegate__typeof,
        (::uType*(*)())&::app::iOS::UIKit::Interop::IUIKeyInput__typeof,
        (::uType*(*)())&::app::iOS::UIKit::Interop::IUIScrollViewDelegate__typeof,
        (::uType*(*)())&::app::iOS::UIKit::Interop::IUITextInput__typeof,
        (::uType*(*)())&::app::iOS::UIKit::Interop::IUITextInputDelegate__typeof,
        (::uType*(*)())&::app::iOS::UIKit::Interop::IUITextInputTokenizer__typeof,
        (::uType*(*)())&::app::iOS::UIKit::Interop::IUITextInputTraits__typeof,
        (::uType*(*)())&::app::iOS::UIKit::Interop::IUITextViewDelegate__typeof,
        (::uType*(*)())&::app::iOS::UIKit::NSLayoutManager__typeof,
        (::uType*(*)())&::app::iOS::UIKit::NSMutableParagraphStyle__typeof,
        (::uType*(*)())&::app::iOS::UIKit::NSParagraphStyle__typeof,
        (::uType*(*)())&::app::iOS::UIKit::NSTextAttachment__typeof,
        (::uType*(*)())&::app::iOS::UIKit::NSTextContainer__typeof,
        (::uType*(*)())&::app::iOS::UIKit::NSTextStorage__typeof,
        (::uType*(*)())&::app::iOS::UIKit::UIApplication__typeof,
        (::uType*(*)())&::app::iOS::UIKit::UIBezierPath__typeof,
        (::uType*(*)())&::app::iOS::UIKit::UIButton__typeof,
        (::uType*(*)())&::app::iOS::UIKit::UIColor__typeof,
        (::uType*(*)())&::app::iOS::UIKit::UIControl__typeof,
        (::uType*(*)())&::app::iOS::UIKit::UIEdgeInsets__typeof,
        (::uType*(*)())&::app::iOS::UIKit::UIEvent__typeof,
        (::uType*(*)())&::app::iOS::UIKit::UIFont__typeof,
        (::uType*(*)())&::app::iOS::UIKit::UIImage__typeof,
        (::uType*(*)())&::app::iOS::UIKit::UIImagePickerController__typeof,
        (::uType*(*)())&::app::iOS::UIKit::UIImageView__typeof,
        (::uType*(*)())&::app::iOS::UIKit::UILabel__typeof,
        (::uType*(*)())&::app::iOS::UIKit::UINavigationController__typeof,
        (::uType*(*)())&::app::iOS::UIKit::UIResponder__typeof,
        (::uType*(*)())&::app::iOS::UIKit::UIScrollView__typeof,
        (::uType*(*)())&::app::iOS::UIKit::UISlider__typeof,
        (::uType*(*)())&::app::iOS::UIKit::UISwitch__typeof,
        (::uType*(*)())&::app::iOS::UIKit::UITextField__typeof,
        (::uType*(*)())&::app::iOS::UIKit::UITextPosition__typeof,
        (::uType*(*)())&::app::iOS::UIKit::UITextRange__typeof,
        (::uType*(*)())&::app::iOS::UIKit::UITextView__typeof,
        (::uType*(*)())&::app::iOS::UIKit::UITouch__typeof,
        (::uType*(*)())&::app::iOS::UIKit::UIView__typeof,
        (::uType*(*)())&::app::iOS::UIKit::UIViewController__typeof,
        (::uType*(*)())&::app::iOS::UIKit::UIWindow__typeof,
        (::uType*(*)())&::app::iOS::WebKit::WKNavigation__typeof,
        (::uType*(*)())&::app::iOS::WebKit::WKWebView__typeof,
        (::uType*(*)())&::app::MainView__typeof,
        (::uType*(*)())&::app::MainView_Factory__typeof,
        (::uType*(*)())&::app::MainView_Factory1__typeof,
        (::uType*(*)())&::app::MainView_Factory2__typeof,
        (::uType*(*)())&::app::MainView_Factory3__typeof,
        (::uType*(*)())&::app::MainView_Fuse_Controls_EdgeNavigator_Fuse_Node_Active_Property__typeof,
        ...
        (::uType*(*)())&::app::MainView_Fuse_Elements_Element_float_Width_Property__typeof,
        (::uType*(*)())&::app::MainView_Fuse_Reactive_Each_object_Items_Property__typeof,
        (::uType*(*)())&::app::MainView_Fuse_Rotation_float_Degrees_Property__typeof,
        (::uType*(*)())&::app::MainView_Fuse_Translation_float_X_Property__typeof,
        (::uType*(*)())&::app::MainView_Fuse_Translation_float_Y_Property__typeof,
        (::uType*(*)())&::app::MenuLabel__typeof,
        (::uType*(*)())&::app::ObjC::ID__typeof,
        (::uType*(*)())&::app::ObjC::Object__typeof,
        (::uType*(*)())&::app::ObjC::Selector__typeof,
        ...
        (::uType*(*)())&::app::Relations__typeof,
        (::uType*(*)())&::app::Sidebar__typeof,
        (::uType*(*)())&::app::SidebarIcon__typeof,
        (::uType*(*)())&::app::Stats__typeof,
        ...
        (::uType*(*)())&::app::Uno::Collections::Dictionary__iOS_Foundation_INSCopying__ObjC_ID__typeof,
        (::uType*(*)())&::app::Uno::Collections::Dictionary__iOS_UIKit_UIControl__Fuse_Node__typeof,
        ...
        (::uType*(*)())&::app::Uno::Collections::Dictionary__Uno_UX_FileSource__iOS_UIKit_UIImage__typeof,
        ...
        (::uType*(*)())&::app::Uno::Collections::Dictionary2_Bucket__iOS_Foundation_INSCopying__ObjC_ID__typeof,
        (::uType*(*)())&::app::Uno::Collections::Dictionary2_Bucket__iOS_UIKit_UIControl__Fuse_Node__typeof,
        ...
        (::uType*(*)())&::app::Uno::Collections::Dictionary2_Bucket__Uno_UX_FileSource__iOS_UIKit_UIImage__typeof,
        ...
        (::uType*(*)())&::app::Uno::Collections::Dictionary2_Enumerator__iOS_Foundation_INSCopying__ObjC_ID__typeof,
        ...
        (::uType*(*)())&::app::Uno::Collections::KeyValuePair__iOS_Foundation_INSCopying__ObjC_ID__typeof,
        ...
        (::uType*(*)())&::app::Uno::Collections::List__byte__typeof,
        ...
        (::uType*(*)())&::app::Uno::Collections::List__int4__typeof,
        (::uType*(*)())&::app::Uno::Collections::List__iOS_QuartzCore_CAShapeLayer__typeof,
        ...
        (::uType*(*)())&::app::Uno::Compiler::ExportTargetInterop::OptionalAttribute__typeof,
        ...
        (::uType*(*)())&::app::Uno::Compiler::HideFromCodeCompleterAttribute__typeof,
        ...
        (::uType*(*)())&::app::Uno::Net::Http::Implementation::iOSHttpRequest__typeof,
        (::uType*(*)())&::app::Uno::Net::Http::Implementation::iOSHttpRequestHandle__typeof,
        (::uType*(*)())&::app::Uno::Net::Http::Implementation::iOSHttpSharedCache__typeof,
        ...
        (::uType*(*)())&::app::Uno::Platform::iOS::StatusBar__typeof,
        ...
        (::uType*(*)())&::app::Uno::UX::Property__Fuse_Node__typeof,
        (::uType*(*)())&::app::Uno::UX::Property__object__typeof,
        ...
        (::uType*(*)())&::app::Uno::UX::ValueChangedArgs__object__typeof,
