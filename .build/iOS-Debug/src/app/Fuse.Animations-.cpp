...
void ResizeAnimatorState__SeekValue(ResizeAnimatorState* __this, ::app::Uno::Float4 value, float strength)
{
    ...
    {
        ::app::Uno::Float2 sz = ::app::Uno::Float2__op_Addition_2(NULL, baseSize, ::app::Uno::Float2__op_Multiply_2(NULL, ::app::Uno::Float2__op_Multiply_1(NULL, deltaSize, ::app::Uno::Float2__New_2(NULL, value.X, value.Y)), strength));
...
bool SpinState__Seek(SpinState* __this, bool on, float interval, float strength, int dir)
{
    ...
    {
        ::app::Uno::Diagnostics::Debug__Log_1(NULL, ::uGetConstString("Invalid seek"), 1, ::uGetConstString("/usr/local/share/uno/Packages/Fuse.Animations/0.11.3/$.uno"), 2450);
        return true;
    }
