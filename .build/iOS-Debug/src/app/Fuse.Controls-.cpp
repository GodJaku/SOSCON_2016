...
// This file was generated based on '/usr/local/share/uno/Packages/Fuse.Controls/0.11.3/.cache/GeneratedCode/$.uno'.
...
void BottomFrameBackground__OnFrameResized(BottomFrameBackground* __this, ::uObject* sender, ::app::Uno::Platform::SystemUIWillResizeEventArgs* args)
{
    ...
    {
        ::app::Uno::Platform2::Display* display = ::app::Uno::Platform2::Display__get_MainDisplay(NULL);
        newHeight = ::app::Uno::Rect__Intersect(NULL, ::uPtr< ::app::Uno::Platform2::Display*>(display)->Frame(), ::app::Uno::Platform::SystemUI__get_BottomFrame(NULL)).Size().Y;
    }
...
{
    ::app::Fuse::Diagnostics__Deprecated(NULL, ::uGetConstString("Use `Layer=\"Background\"` instead of setting the appearance on a Panel"), (::uObject*)c, ::uGetConstString("/usr/local/share/uno/Packages/Fuse.Controls/0.11.3/$.uno"), 2031, ::uGetConstString("SetAppearance"));
