...
::app::Fuse::Layouts::DefinitionBase_ParseDataItem DefinitionBase__ParseDataSingle(::uStatic* __this, ::uString* data)
{
    ...
    catch (const ::uThrowable& __t)
    {
        if (::uIs(__t.Exception, ::app::Uno::Exception__typeof()))
        {
            ...
            ::app::Uno::Diagnostics::Debug__Log_1(NULL, ::app::Uno::String__op_Addition_1(NULL, ::uGetConstString("Unable to parse data: "), data), 1, ::uGetConstString("/usr/local/share/uno/Packages/Fuse.Controls/0.11.3/Layouts/$.uno"), 445);
