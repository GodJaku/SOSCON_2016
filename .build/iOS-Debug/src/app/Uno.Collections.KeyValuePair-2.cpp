...
{
    static ::uStaticStrong<KeyValuePair__iOS_Foundation_INSCopying__ObjC_ID__uType*> type;
    if (type != NULL) return type;

    type = (KeyValuePair__iOS_Foundation_INSCopying__ObjC_ID__uType*)::uAllocStructType(sizeof(KeyValuePair__iOS_Foundation_INSCopying__ObjC_ID__uType), "Uno.Collections.KeyValuePair<iOS.Foundation.INSCopying,ObjC.ID>", sizeof(KeyValuePair__iOS_Foundation_INSCopying__ObjC_ID), 0, 1, 0);

    type->SetStrongRefs(
        "_key", offsetof(KeyValuePair__iOS_Foundation_INSCopying__ObjC_ID, _key));
...
{
    KeyValuePair__iOS_Foundation_INSCopying__ObjC_ID inst = ::uDefault< KeyValuePair__iOS_Foundation_INSCopying__ObjC_ID>();
    inst._ObjInit(key, value);
    return inst;
}
