...
void App___ObjInit_2(App* __this)
{
    ...
    __this->OnSetTheme(__this->Theme());
    ::app::Uno::Collections::ICollection__Fuse_Style::Add(::uPtr< ::uObject*>(::uPtr< ::app::Fuse::RootViewport*>(__this->RootViewport())->Styles()), (::app::Fuse::Style*)::app::Fuse::iOS::NativeStyle__New_2(NULL));
    __this->_startTime = ::app::Uno::Diagnostics::Clock__GetSeconds(NULL);
    __this->_prevTime = __this->_startTime;
    ::uPtr< ::app::Uno::Platform2::Display*>(::app::Uno::Platform2::Display__get_MainDisplay(NULL))->add_Tick(::uNewDelegateNonVirt(::app::Uno::EventHandler__Uno_Platform_TimerEventArgs__typeof(), (const void*)App__OnTick, __this));
}
...
void App__OnTick(App* __this, ::uObject* sender, ::app::Uno::Platform::TimerEventArgs* args)
{
    ...
    double totalTime = t - __this->_startTime;
    ::app::Fuse::Time__Set(NULL, t - __this->_startTime, t - __this->_prevTime);
    __this->_prevTime = t;
...
{
    ::app::Uno::Diagnostics::Debug__Log_1(NULL, ::app::Uno::String__op_Addition(NULL, ::app::Uno::String__op_Addition_1(NULL, msg, ::uGetConstString(" ")), obj), 3, filePath, lineNumber);
}
...
{
    {
        ...
        __this->CheckGLError(::uGetConstString("/usr/local/share/uno/Packages/FuseCore/0.11.3/$.uno"), 500, ::uGetConstString("CaptureRootbuffer"));
        __this->_glScissor = ::app::OpenGL::GL__GetInteger_1(NULL, 3088);
        __this->_glViewport = ::app::OpenGL::GL__GetInteger_1(NULL, 2978);
    ...
    {
        {
            ...
            if (e != 0)
            {
                ::app::Fuse::Diagnostics__Error(NULL, ::app::Uno::String__op_Addition(NULL, ::uGetConstString(""), ::uBox< int>(::app::OpenGL::GLError__typeof(), e)), (::uObject*)__this, filePath, lineNumber, memberName);
            }
        }
    }
}
...
{
    {
        ...
        __this->CheckGLError(::uGetConstString("/usr/local/share/uno/Packages/FuseCore/0.11.3/$.uno"), 627, ::uGetConstString("Clear"));
    }
}
...
{
    {
        ::app::Uno::Int4 s = ::app::OpenGL::GL__GetInteger_1(NULL, 3088);

        if (::app::Uno::Int4__op_Inequality(NULL, s, __this->_glScissor))
        {
            __this->GLInconsistent(::app::Uno::String__op_Addition(NULL, ::app::Uno::String__op_Addition_1(NULL, ::app::Uno::String__op_Addition(NULL, ::uGetConstString("GLScissor: "), ::uBox(::app::Uno::Int4__typeof(), s)), ::uGetConstString(" != ")), ::uBox(::app::Uno::Int4__typeof(), __this->_glScissor)));
        }
    }
...
{
    {
        ::app::Uno::Int4 vpp = ::app::OpenGL::GL__GetInteger_1(NULL, 2978);

        if (::app::Uno::Int4__op_Inequality(NULL, __this->_glViewport, vpp))
        {
            __this->GLInconsistent(::app::Uno::String__op_Addition(NULL, ::app::Uno::String__op_Addition_1(NULL, ::app::Uno::String__op_Addition(NULL, ::uGetConstString("GLViewport: "), ::uBox(::app::Uno::Int4__typeof(), vpp)), ::uGetConstString(" != ")), ::uBox(::app::Uno::Int4__typeof(), __this->_glViewport)));
        }
    }
...
{
    ::app::Fuse::Diagnostics__Error(NULL, ::app::Uno::String__op_Addition_1(NULL, ::uGetConstString("Inconsistent GL state: "), msg), (::uObject*)__this, ::uGetConstString("/usr/local/share/uno/Packages/FuseCore/0.11.3/$.uno"), 769, ::uGetConstString("GLInconsistent"));
}
...
void DrawContext__PopRenderTarget(DrawContext* __this)
{
    ...
    __this->_renderTarget = ::uPtr< ::app::Fuse::RenderTargetEntry*>(old)->RenderTarget;
    {
        ...
        __this->CheckGLError(::uGetConstString("/usr/local/share/uno/Packages/FuseCore/0.11.3/$.uno"), 601, ::uGetConstString("PopRenderTarget"));
    }
...
{
    __this->PushRenderTarget_2(rt, ::uPtr< ::app::Uno::Graphics::RenderTarget*>(rt)->Size(), ::app::Uno::Int4__New_3(NULL, 0, 0, ::uPtr< ::app::Uno::Graphics::RenderTarget*>(rt)->Size().X, ::uPtr< ::app::Uno::Graphics::RenderTarget*>(rt)->Size().Y));
}
...
void DrawContext__PushRenderTarget_2(DrawContext* __this, ::app::Uno::Graphics::RenderTarget* rt, ::app::Uno::Int2 viewportPixelSize, ::app::Uno::Int4 glscissor)
{
    ...
    ::uPtr< ::app::Uno::Collections::List__Fuse_RenderTargetEntry*>(__this->_renderTargets)->Add(__this->GetRenderTargetEntry());
    {
        ...
        __this->CheckGLError(::uGetConstString("/usr/local/share/uno/Packages/FuseCore/0.11.3/$.uno"), 586, ::uGetConstString("PushRenderTarget"));
    }
...
void DrawContext__ReleaseRootbuffer(DrawContext* __this)
{
    ...
    {
        ::app::Fuse::Diagnostics__Error(NULL, ::uGetConstString("Unpopped Scissor"), (::uObject*)__this, ::uGetConstString("/usr/local/share/uno/Packages/FuseCore/0.11.3/$.uno"), 517, ::uGetConstString("ReleaseRootbuffer"));
    }
    ...
    {
        ::app::Fuse::Diagnostics__Error(NULL, ::uGetConstString("Unpopped CullFace"), (::uObject*)__this, ::uGetConstString("/usr/local/share/uno/Packages/FuseCore/0.11.3/$.uno"), 521, ::uGetConstString("ReleaseRootbuffer"));
    }
    ...
    {
        ::app::Fuse::Diagnostics__Error(NULL, ::uGetConstString("Unpopped Viewport"), (::uObject*)__this, ::uGetConstString("/usr/local/share/uno/Packages/FuseCore/0.11.3/$.uno"), 525, ::uGetConstString("ReleaseRootbuffer"));
    }
    ...
    {
        ::app::Fuse::Diagnostics__Error(NULL, ::uGetConstString("Unpopped RenderTarget"), (::uObject*)__this, ::uGetConstString("/usr/local/share/uno/Packages/FuseCore/0.11.3/$.uno"), 529, ::uGetConstString("ReleaseRootbuffer"));
    }
...
void DrawContext__set_GLFramebuffer(DrawContext* __this, ::uUInt value)
{
    ...
    __this->CheckGLError(::uGetConstString("/usr/local/share/uno/Packages/FuseCore/0.11.3/$.uno"), 557, ::uGetConstString("set_GLFramebuffer"));
}
...
void DrawContext__set_GLScissor(DrawContext* __this, ::app::Uno::Int4 value)
{
    __this->_glScissor = value;
    {
        ...
        __this->CheckGLError(::uGetConstString("/usr/local/share/uno/Packages/FuseCore/0.11.3/$.uno"), 668, ::uGetConstString("set_GLScissor"));
    }
}

void DrawContext__set_GLViewportPixelSize(DrawContext* __this, ::app::Uno::Int2 value)
{
    __this->_glViewport = ::app::Uno::Int4__New_3(NULL, 0, 0, value.X, value.Y);
    {
        ::app::OpenGL::GL__Viewport(NULL, 0, 0, value.X, value.Y);
        __this->CheckGLError(::uGetConstString("/usr/local/share/uno/Packages/FuseCore/0.11.3/$.uno"), 712, ::uGetConstString("set_GLViewportPixelSize"));
    }
}
...
{
    ::app::Uno::Int2 vsz = __this->GLViewportPixelSize();
    __this->GLScissor(::app::Uno::Int4__New_3(NULL, value.Left, vsz.Y - (value.Top + value.Size().Y), value.Size().X, value.Size().Y));
}
...
void DrawHelpers__init_DrawCalls(DrawHelpers* __this)
{
    ...
    __this->_draw_9c5663de = ::app::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall__New_1(NULL, ::uCast< ::app::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram*>(::app::Uno::Runtime::Implementation::Internal::BundleRegistry__Get(NULL, 111), ::app::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram__typeof()));
}
...
::app::Fuse::Font* Fonts__get_Fallback(::uStatic* __this)
{
    ...
    {
        Fonts___fallback = ::app::Fuse::Font__New_1(NULL, (::app::Uno::UX::FileSource*)::app::Uno::UX::BundleFileSource__New_1(NULL, ::uCast< ::app::Uno::BundleFile*>(::app::Uno::Runtime::Implementation::Internal::BundleRegistry__Get(NULL, 6), ::app::Uno::BundleFile__typeof())));
    }
...
// This file was generated based on '/usr/local/share/uno/Packages/Fuse.Launcher/0.11.3/$.uno'.
// WARNING: Changes might be lost if you edit this file directly.
...
{
    {
        ::app::iOS::Foundation::NSURL* mapURL = ::app::iOS::Foundation::NSURL__New_6(NULL, ::app::iOS::Foundation::NSURL___urlWithString(NULL, uri));
        ::uPtr< ::app::iOS::UIKit::UIApplication*>(::app::iOS::UIKit::UIApplication___sharedApplication(NULL))->openURL(mapURL);
    }
}
...
void Launcher__LaunchCall(::uStatic* __this, ::uString* callString)
{
    ...
    {
        ::app::iOS::UIKit::UIApplication* app = ::app::iOS::UIKit::UIApplication___sharedApplication(NULL);
        ::app::iOS::Foundation::NSURL* telephoneURL = ::app::iOS::Foundation::NSURL__New_6(NULL, ::app::iOS::Foundation::NSURL___urlWithString(NULL, ::uPtr< ::app::Uno::Text::StringBuilder*>(builder)->ToString()));
        ::uPtr< ::app::iOS::UIKit::UIApplication*>(app)->openURL(telephoneURL);
    }
}
...
void Launcher__LaunchEmail(::uStatic* __this, ::uString* to, ::uString* carbonCopy, ::uString* blindCarbonCopy, ::uString* subject, ::uString* message)
{
    ...
    {
        ::app::iOS::UIKit::UIApplication* app = ::app::iOS::UIKit::UIApplication___sharedApplication(NULL);
        ::app::iOS::Foundation::NSURL* mailURL = ::app::iOS::Foundation::NSURL__New_6(NULL, ::app::iOS::Foundation::NSURL___urlWithString(NULL, ::uPtr< ::app::Uno::Text::StringBuilder*>(builder)->ToString()));
        ::uPtr< ::app::iOS::UIKit::UIApplication*>(app)->openURL(mailURL);
    }
}
...
void Launcher__LaunchMaps(::uStatic* __this, double latitude, double longitude)
{
    ...
    {
        Launcher___launchMaps(NULL, ::app::Uno::String__op_Addition_1(NULL, ::app::Uno::String__op_Addition_1(NULL, ::app::Uno::String__op_Addition_1(NULL, ::uGetConstString("http://maps.apple.com/maps?q="), latlon), ::uGetConstString("&ll=")), latlon));
    }
}
...
{
    {
        Launcher___launchMaps(NULL, ::app::Uno::String__op_Addition_1(NULL, ::uGetConstString("http://maps.apple.com/maps?q="), query));
    }
}
...
void Launcher__LaunchUri(::uStatic* __this, ::app::Uno::Net::Http::Uri* uri)
{
    ...
    {
        ::app::iOS::UIKit::UIApplication* app = ::app::iOS::UIKit::UIApplication___sharedApplication(NULL);
        ::app::iOS::Foundation::NSURL* siteURL = ::app::iOS::Foundation::NSURL__New_6(NULL, ::app::iOS::Foundation::NSURL___urlWithString(NULL, ::uPtr< ::app::Uno::Text::StringBuilder*>(builder)->ToString()));
        ::uPtr< ::app::iOS::UIKit::UIApplication*>(app)->openURL(siteURL);
    }
}
...
{
    __this->PerformLayout(::app::Fuse::IViewport::Size(::uPtr< ::uObject*>(__this->Viewport())));
}
