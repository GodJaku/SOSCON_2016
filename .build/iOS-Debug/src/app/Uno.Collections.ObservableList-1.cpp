...
// This file was generated based on '/usr/local/share/uno/Packages/Uno.Collections/0.13.2/$.uno'.
...
ObservableList__Uno_UX_IFactory__uType* ObservableList__Uno_UX_IFactory__typeof()
{
    ...
    type = (ObservableList__Uno_UX_IFactory__uType*)::uAllocClassType(sizeof(ObservableList__Uno_UX_IFactory__uType), "Uno.Collections.ObservableList<Uno.UX.IFactory>", false, 3, 3, 0);

    type->__interface_1.__fp_Add = (void(*)(void*, ::uObject*))ObservableList__Uno_UX_IFactory__Add;
    type->__interface_2.__fp_GetEnumerator = (::uObject*(*)(void*))ObservableList__Uno_UX_IFactory__GetEnumerator;

    type->SetInterfaces(
        ::app::Uno::Collections::IList__Uno_UX_IFactory__typeof(), offsetof(ObservableList__Uno_UX_IFactory__uType, __interface_0),
        ::app::Uno::Collections::ICollection__Uno_UX_IFactory__typeof(), offsetof(ObservableList__Uno_UX_IFactory__uType, __interface_1),
        ::app::Uno::Collections::IEnumerable__Uno_UX_IFactory__typeof(), offsetof(ObservableList__Uno_UX_IFactory__uType, __interface_2));
