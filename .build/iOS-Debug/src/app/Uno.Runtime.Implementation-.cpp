...
// This file was generated based on '/usr/local/share/uno/Packages/UnoCore/0.13.2/Source/Uno/Runtime/Implementation/$.uno'.
...
bool GenericEqualsImpl__Equals__iOS_Foundation_INSCopying(::uStatic* __this, ::uObject* left_, ::uObject* right_)
{
    return ::uGenericEquals(left_, right_);
}

bool GenericEqualsImpl__Equals__iOS_UIKit_UIControl(::uStatic* __this, ::app::iOS::UIKit::UIControl* left_, ::app::iOS::UIKit::UIControl* right_)
{
    return ::uGenericEquals(left_, right_);
}
...
::uString* TextEncodingImpl__DecodeAscii(::uStatic* __this, ::uArray* value)
{
    ...
    for (int i = 0; i < ::uPtr< ::uArray*>(value)->Length(); i++)
    {
        ...
        {
            res = ::app::Uno::String__op_Addition(NULL, res, ::uBox< ::uChar>(::app::Uno::Char__typeof(), '?'));
        }
        else
        {
            res = ::app::Uno::String__op_Addition(NULL, res, ::uBox< ::uChar>(::app::Uno::Char__typeof(), (::uChar)::uPtr< ::uArray*>(value)->Item< ::uByte>(i)));
        }
    }
...
::uArray* TextEncodingImpl__DecodeBase64(::uStatic* __this, ::uString* value)
{
    ...
    {
        if ((::uPtr< ::uString*>(value)->Item(position) == '=') || (::app::Uno::String::IndexOf_1(::uPtr< ::uString*>(::uGetConstString("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/")), ::uPtr< ::uString*>(value)->Item(position), 0) < 0))
        {
            break;
        }
        ...
        if (addidionalSymbols == 4)
        {
            for (int j = 0; j < 4; j++)
            {
                ::uPtr< ::uArray*>(charArray4)->Item< int>(j) = ::app::Uno::String::IndexOf_1(::uPtr< ::uString*>(::uGetConstString("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/")), (::uChar)::uPtr< ::uArray*>(charArray4)->Item< int>(j), 0);
            }
