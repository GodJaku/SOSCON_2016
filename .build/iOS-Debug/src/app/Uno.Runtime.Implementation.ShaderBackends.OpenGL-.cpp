...
// This file was generated based on '/usr/local/share/uno/Packages/UnoCore/0.13.2/Source/Uno/Runtime/Implementation/ShaderBackends/OpenGL/$.uno'.
...
void GLHelpers__CheckError(::uStatic* __this)
{
    ...
    if (err != 0)
    {
        ::app::Uno::Diagnostics::Debug__Log_3(NULL, ::app::Uno::String__op_Addition_1(NULL, ::app::Uno::String__op_Addition_1(NULL, ::uGetConstString("GL error ("), ::app::Uno::Int::ToString(err)), ::uGetConstString(")")), 3);
    }
}
