...
{
    static ::uStaticStrong<MainView_Fuse_Elements_Element_float_Width_Property__uType*> type;
    if (type != NULL) return type;

    type = (MainView_Fuse_Elements_Element_float_Width_Property__uType*)::uAllocClassType(sizeof(MainView_Fuse_Elements_Element_float_Width_Property__uType), "MainView.Fuse_Elements_Element_float_Width_Property", false, 0, 1, 0);

    type->SetBaseType(::app::Uno::UX::Property__float__typeof());
    type->__fp_OnGet = (float(*)(::app::Uno::UX::Property__float*))MainView_Fuse_Elements_Element_float_Width_Property__OnGet;
    type->__fp_OnSet = (void(*)(::app::Uno::UX::Property__float*, float, ::uObject*))MainView_Fuse_Elements_Element_float_Width_Property__OnSet;

    type->SetStrongRefs(
        "_obj", offsetof(MainView_Fuse_Elements_Element_float_Width_Property, _obj));
...
{
    MainView_Fuse_Elements_Element_float_Width_Property* inst = (MainView_Fuse_Elements_Element_float_Width_Property*)::uAllocObject(sizeof(MainView_Fuse_Elements_Element_float_Width_Property), MainView_Fuse_Elements_Element_float_Width_Property__typeof());
    inst->_ObjInit_1(obj);
    return inst;
}
