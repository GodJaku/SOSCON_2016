...
void MixerHandle__bool__Set(MixerHandle__bool* __this, bool value, float strength)
{
    ...
    {
        ::app::Uno::Diagnostics::Debug__Log_1(NULL, ::uGetConstString("invalid MixerHandle.Set post-Unregister"), 1, ::uGetConstString("/usr/local/share/uno/Packages/Fuse.Animations/0.11.3/$.uno"), 1791);
        return;
    }
