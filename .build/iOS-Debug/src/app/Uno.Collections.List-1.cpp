...
List__byte__uType* List__byte__typeof()
{
    ...
    type = (List__byte__uType*)::uAllocClassType(sizeof(List__byte__uType), "Uno.Collections.List<byte>", false, 0, 1, 0);
...
List__int4__uType* List__int4__typeof()
{
    ...
    type = (List__int4__uType*)::uAllocClassType(sizeof(List__int4__uType), "Uno.Collections.List<int4>", false, 2, 1, 0);
...
{
    static ::uStaticStrong<List__iOS_QuartzCore_CAShapeLayer__uType*> type;
    if (type != NULL) return type;

    type = (List__iOS_QuartzCore_CAShapeLayer__uType*)::uAllocClassType(sizeof(List__iOS_QuartzCore_CAShapeLayer__uType), "Uno.Collections.List<iOS.QuartzCore.CAShapeLayer>", false, 0, 1, 0);

    type->SetStrongRefs(
        "_data", offsetof(List__iOS_QuartzCore_CAShapeLayer, _data));
...
{
    __this->EnsureCapacity();
    ::uPtr< ::uArray*>(__this->_data)->ItemStrong< ::app::iOS::QuartzCore::CAShapeLayer*>(__this->_used++) = item;
    __this->_version++;
}
...
void List__iOS_QuartzCore_CAShapeLayer__EnsureCapacity(List__iOS_QuartzCore_CAShapeLayer* __this)
{
    if (__this->_data == NULL)
    {
        __this->_data = ::uNewArray(::app::iOS::QuartzCore::CAShapeLayer__typeof(), 2);
    }
    else if ((__this->_used + 1) == ::uPtr< ::uArray*>(__this->_data)->Length())
    {
        ::uArray* newData = ::uNewArray(::app::iOS::QuartzCore::CAShapeLayer__typeof(), ::uPtr< ::uArray*>(__this->_data)->Length() * 2);

        for (int i = 0; i < __this->_used; i++)
        {
            newData->ItemStrong< ::app::iOS::QuartzCore::CAShapeLayer*>(i) = ::uPtr< ::uArray*>(__this->_data)->Item< ::app::iOS::QuartzCore::CAShapeLayer*>(i);
        }
...
{
    __this->BoundsCheck(index);
    return ::uPtr< ::uArray*>(__this->_data)->Item< ::app::iOS::QuartzCore::CAShapeLayer*>(index);
}

List__iOS_QuartzCore_CAShapeLayer* List__iOS_QuartzCore_CAShapeLayer__New_1(::uStatic* __this)
{
    List__iOS_QuartzCore_CAShapeLayer* inst = (List__iOS_QuartzCore_CAShapeLayer*)::uAllocObject(sizeof(List__iOS_QuartzCore_CAShapeLayer), List__iOS_QuartzCore_CAShapeLayer__typeof());
    inst->_ObjInit();
    return inst;
}
...
void List__iOS_QuartzCore_CAShapeLayer__RemoveAt(List__iOS_QuartzCore_CAShapeLayer* __this, int index)
{
    ...
    for (int i = index; i < (__this->_used - 1); i++)
    {
        ::uPtr< ::uArray*>(__this->_data)->ItemStrong< ::app::iOS::QuartzCore::CAShapeLayer*>(i) = ::uPtr< ::uArray*>(__this->_data)->Item< ::app::iOS::QuartzCore::CAShapeLayer*>(i + 1);
    }

    __this->_used = __this->_used - 1;
    ::uPtr< ::uArray*>(__this->_data)->ItemStrong< ::app::iOS::QuartzCore::CAShapeLayer*>(__this->_used) = NULL;
    __this->_version++;
}
...
{
    __this->BoundsCheck(index);
    ::uPtr< ::uArray*>(__this->_data)->ItemStrong< ::app::iOS::QuartzCore::CAShapeLayer*>(index) = value;
    __this->_version++;
}
...
List__Uno_UX_IFactory__uType* List__Uno_UX_IFactory__typeof()
{
    ...
    type = (List__Uno_UX_IFactory__uType*)::uAllocClassType(sizeof(List__Uno_UX_IFactory__uType), "Uno.Collections.List<Uno.UX.IFactory>", false, 3, 1, 0);

    type->__interface_1.__fp_Add = (void(*)(void*, ::uObject*))List__Uno_UX_IFactory__Add;
    type->__interface_2.__fp_GetEnumerator = (::uObject*(*)(void*))List__Uno_UX_IFactory__GetEnumerator_boxed;

    type->SetInterfaces(
        ::app::Uno::Collections::IList__Uno_UX_IFactory__typeof(), offsetof(List__Uno_UX_IFactory__uType, __interface_0),
        ::app::Uno::Collections::ICollection__Uno_UX_IFactory__typeof(), offsetof(List__Uno_UX_IFactory__uType, __interface_1),
        ::app::Uno::Collections::IEnumerable__Uno_UX_IFactory__typeof(), offsetof(List__Uno_UX_IFactory__uType, __interface_2));
