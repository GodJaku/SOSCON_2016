...
// This file was generated based on '/usr/local/share/uno/Packages/Uno.Net.Http/0.13.2/UriParsers/$.uno'.
...
// This file was generated based on '/usr/local/share/uno/Packages/Uno.Net.Http/0.13.2/$.uno'.
// WARNING: Changes might be lost if you edit this file directly.
...
void HttpMessageCache__Init(::uStatic* __this)
{
    ...
    ::app::Uno::Net::Http::Implementation::iOSHttpSharedCache__SetupSharedCache(NULL, HttpMessageCache__get_IsCacheEnabled(NULL), HttpMessageCache__get_MaxCacheSizeInBytes(NULL));
}
...
void HttpMessageCache__set_IsCacheEnabled(::uStatic* __this, bool value)
{
    if (HttpMessageCache___isInitialized)
    {
        ::app::Uno::Diagnostics::Debug__Log_1(NULL, ::uGetConstString("Uno.Net.Http.HttpMessageCache: Changes to IsCacheEnabled are ignored after initialization."), 1, ::uGetConstString("/usr/local/share/uno/Packages/Uno.Net.Http/0.13.2/$.uno"), 17);
    }
    else
    {
...
void HttpMessageCache__set_MaxCacheSizeInBytes(::uStatic* __this, ::uLong value)
{
    if (HttpMessageCache___isInitialized)
    {
        ::app::Uno::Diagnostics::Debug__Log_1(NULL, ::uGetConstString("Uno.Net.Http.HttpMessageCache: Changes to MaxCacheSizeInBytes are ignored after initialization."), 1, ::uGetConstString("/usr/local/share/uno/Packages/Uno.Net.Http/0.13.2/$.uno"), 30);
    }
    else
    {
...
HttpMessageHandlerRequest__uType* HttpMessageHandlerRequest__typeof()
{
    ...
    type = (HttpMessageHandlerRequest__uType*)::uAllocClassType(sizeof(HttpMessageHandlerRequest__uType), "Uno.Net.Http.HttpMessageHandlerRequest", false, 1, 11, 0);
...
void HttpMessageHandlerRequest___ObjInit(HttpMessageHandlerRequest* __this, ::app::Uno::Net::Http::HttpMessageHandler* handler, ::uString* method, ::uString* url, ::uObject* dispatcher)
{
    ...
    __this->_httpRequest = (::uObject*)::app::Uno::Net::Http::Implementation::iOSHttpRequest__New_1(NULL, __this, method, url);
