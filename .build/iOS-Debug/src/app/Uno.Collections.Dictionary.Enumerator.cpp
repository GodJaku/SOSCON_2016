...
{
    static ::uStaticStrong<Dictionary2_Enumerator__iOS_Foundation_INSCopying__ObjC_ID__uType*> type;
    if (type != NULL) return type;

    type = (Dictionary2_Enumerator__iOS_Foundation_INSCopying__ObjC_ID__uType*)::uAllocStructType(sizeof(Dictionary2_Enumerator__iOS_Foundation_INSCopying__ObjC_ID__uType), "Uno.Collections.Dictionary<iOS.Foundation.INSCopying,ObjC.ID>.Enumerator", sizeof(Dictionary2_Enumerator__iOS_Foundation_INSCopying__ObjC_ID), 2, 2, 0);

    type->__interface_0.__fp_Dispose = (void(*)(void*))Dictionary2_Enumerator__iOS_Foundation_INSCopying__ObjC_ID__Dispose;
    type->__interface_1.__fp_MoveNext = (bool(*)(void*))Dictionary2_Enumerator__iOS_Foundation_INSCopying__ObjC_ID__MoveNext;

    type->SetInterfaces(
        ::app::Uno::IDisposable__typeof(), offsetof(Dictionary2_Enumerator__iOS_Foundation_INSCopying__ObjC_ID__uType, __interface_0),
        ::app::Uno::Collections::IEnumerator__typeof(), offsetof(Dictionary2_Enumerator__iOS_Foundation_INSCopying__ObjC_ID__uType, __interface_1));

    type->SetStrongRefs(
        "_current._key", offsetof(Dictionary2_Enumerator__iOS_Foundation_INSCopying__ObjC_ID, _current._key),
        "_source", offsetof(Dictionary2_Enumerator__iOS_Foundation_INSCopying__ObjC_ID, _source));
...
{
    __this->_source = source;
    __this->_version = ::uPtr< ::app::Uno::Collections::Dictionary__iOS_Foundation_INSCopying__ObjC_ID*>(source)->_version;
    __this->_iterator = -1;
}
...
{
    if (__this->_version != ::uPtr< ::app::Uno::Collections::Dictionary__iOS_Foundation_INSCopying__ObjC_ID*>(__this->_source)->_version)
    {
        U_THROW(::app::Uno::InvalidOperationException__New_4(NULL, ::uGetConstString("Collection was modified")));
    }
    ...
    do
    {
        ...
        if (__this->_iterator >= ::uPtr< ::uArray*>(::uPtr< ::app::Uno::Collections::Dictionary__iOS_Foundation_INSCopying__ObjC_ID*>(__this->_source)->_buckets)->Length())
        {
            return false;
        }
    }
    while (::uPtr< ::uArray*>(::uPtr< ::app::Uno::Collections::Dictionary__iOS_Foundation_INSCopying__ObjC_ID*>(__this->_source)->_buckets)->Item< ::app::Uno::Collections::Dictionary2_Bucket__iOS_Foundation_INSCopying__ObjC_ID>(__this->_iterator).State != 1);

    ::app::Uno::Collections::Dictionary2_Bucket__iOS_Foundation_INSCopying__ObjC_ID bucket = ::uPtr< ::uArray*>(::uPtr< ::app::Uno::Collections::Dictionary__iOS_Foundation_INSCopying__ObjC_ID*>(__this->_source)->_buckets)->Item< ::app::Uno::Collections::Dictionary2_Bucket__iOS_Foundation_INSCopying__ObjC_ID>(__this->_iterator);
    __this->_current = ::app::Uno::Collections::KeyValuePair__iOS_Foundation_INSCopying__ObjC_ID__New_1(NULL, bucket.Key, bucket.Value);
    return true;
}
...
{
    Dictionary2_Enumerator__iOS_Foundation_INSCopying__ObjC_ID inst = ::uDefault< Dictionary2_Enumerator__iOS_Foundation_INSCopying__ObjC_ID>();
    inst._ObjInit(source);
    return inst;
}
