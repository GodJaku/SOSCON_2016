...
// This file was generated based on '/usr/local/share/uno/Packages/Experimental.Http/0.11.3/$.uno'.
...
bool Loader__LoadCache(Loader* __this, ::uObject* record)
{
    ...
    catch (const ::uThrowable& __t)
    {
        ...
        {
            ::app::Uno::Exception* e = (::app::Uno::Exception*)__t.Exception;
            ::app::Uno::Diagnostics::Debug__Log_2(NULL, (::uObject*)e, 1, ::uGetConstString("/usr/local/share/uno/Packages/Experimental.Http/0.11.3/$.uno"), 848);
            ::app::Uno::Diagnostics::Debug__Log_1(NULL, ::app::Uno::String__op_Addition_1(NULL, ::uGetConstString("Failed loading caching: "), __this->Uri), 1, ::uGetConstString("/usr/local/share/uno/Packages/Experimental.Http/0.11.3/$.uno"), 849);
