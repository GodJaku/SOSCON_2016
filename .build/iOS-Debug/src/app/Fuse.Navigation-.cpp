...
// This file was generated based on '/usr/local/share/uno/Packages/Fuse.Navigation/0.11.3/Internal/$.uno'.
// WARNING: Changes might be lost if you edit this file directly.
...
void EdgeNavigation__OnProgressChanged(EdgeNavigation* __this, ::uObject* s, double progress)
{
    ...
    {
        ::app::Uno::Diagnostics::Debug__Log_1(NULL, ::uGetConstString("Unexpected message"), 1, ::uGetConstString("/usr/local/share/uno/Packages/Fuse.Navigation/0.11.3/$.uno"), 285);
        return;
    }
...
void SwipeNavigate__OnPointerPressed(SwipeNavigate* __this, ::uObject* sender, ::app::Fuse::Input::PointerPressedArgs* args)
{
    ...
    if (__this->_currentNavigation == NULL)
    {
        ::app::Uno::Diagnostics::Debug__Log_1(NULL, ::uGetConstString("SwipeNavigate: failed to find suitable Navigation object"), 1, ::uGetConstString("/usr/local/share/uno/Packages/Fuse.Navigation/0.11.3/$.uno"), 1770);
        return;
    }
