...
// This file was generated based on '/usr/local/share/uno/Packages/Fuse.Triggers/0.11.3/$.uno'.
...
// This file was generated based on '/usr/local/share/uno/Packages/Fuse.Elements/0.11.3/Triggers/$.uno'.
// WARNING: Changes might be lost if you edit this file directly.
...
{
    return ::app::Uno::Float3__op_Multiply_1(NULL, ::app::Fuse::Triggers::LayoutAnimation__GetPositionChange(NULL, ::uPtr< ::app::Fuse::Translation*>(t)->RelativeNode()), ::uPtr< ::app::Fuse::Translation*>(t)->Vector());
}
...
// This file was generated based on '/usr/local/share/uno/Packages/Fuse.Controls/0.11.3/Triggers/$.uno'.
// WARNING: Changes might be lost if you edit this file directly.
...
void WhileKeyboardVisible__OnBottomBarResize(WhileKeyboardVisible* __this, ::uObject* sender, ::app::Uno::Platform::SystemUIWillResizeEventArgs* args)
{
    float newHeight = __this->GetHeight(::uPtr< ::app::Uno::Platform::SystemUIWillResizeEventArgs*>(args)->EndFrame());
    {
        ...
        newHeight = ::app::Uno::Rect__Intersect(NULL, ::uPtr< ::app::Uno::Platform2::Display*>(display)->Frame(), ::uPtr< ::app::Uno::Platform::SystemUIWillResizeEventArgs*>(args)->EndFrame()).Size().Y;
    }
