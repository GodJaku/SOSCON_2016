...
::uDelegateType* Action__Fuse_Controls_Control__float4__typeof()
{
    ...
    type = ::uAllocDelegateType("Uno.Action<Fuse.Controls.Control,float4>", 2);
...
::uDelegateType* Action__Fuse_iOS_Controls_Button__typeof()
{
    ...
    type = ::uAllocDelegateType("Uno.Action<Fuse.iOS.Controls.Button>", 1);

    type->SetSignature(::uVoid__typeof(),
        ::app::Fuse::iOS::Controls::Button__typeof());
...
::uDelegateType* Action__Fuse_iOS_Controls_Button__float4__typeof()
{
    ...
    type = ::uAllocDelegateType("Uno.Action<Fuse.iOS.Controls.Button,float4>", 2);
...
::uDelegateType* Action__iOS_Foundation_NSObject__iOS_UIKit_UIEvent__typeof()
{
    static ::uStaticStrong< ::uDelegateType*> type;
    if (type != NULL) return type;

    type = ::uAllocDelegateType("Uno.Action<iOS.Foundation.NSObject,iOS.UIKit.UIEvent>", 2);

    type->SetSignature(::uVoid__typeof(),
        ::app::iOS::Foundation::NSObject__typeof(),
        ::app::iOS::UIKit::UIEvent__typeof());
...
::uDelegateType* EventHandler__iOS_CoreGraphics_CGRect__typeof()
{
    static ::uStaticStrong< ::uDelegateType*> type;
    if (type != NULL) return type;

    type = ::uAllocDelegateType("Uno.EventHandler<iOS.CoreGraphics.CGRect>", 2);

    type->SetSignature(::uVoid__typeof(),
        ::uObject__typeof(),
        ::app::iOS::CoreGraphics::CGRect__typeof());
...
::uDelegateType* Func__Fuse_Controls_Control__float4__typeof()
{
    ...
    type = ::uAllocDelegateType("Uno.Func<Fuse.Controls.Control,float4>", 1);
...
::uDelegateType* Func__Fuse_iOS_Controls_Button__float4__typeof()
{
    ...
    type = ::uAllocDelegateType("Uno.Func<Fuse.iOS.Controls.Button,float4>", 1);
...
{
    return ::app::Uno::Runtime::Implementation::GenericEqualsImpl__Equals__int4(NULL, left, right);
}

bool Generic__Equals__iOS_Foundation_INSCopying(::uStatic* __this, ::uObject* left, ::uObject* right)
{
    return ::app::Uno::Runtime::Implementation::GenericEqualsImpl__Equals__iOS_Foundation_INSCopying(NULL, left, right);
}

bool Generic__Equals__iOS_UIKit_UIControl(::uStatic* __this, ::app::iOS::UIKit::UIControl* left, ::app::iOS::UIKit::UIControl* right)
{
    return ::app::Uno::Runtime::Implementation::GenericEqualsImpl__Equals__iOS_UIKit_UIControl(NULL, left, right);
}
...
{
    return !::app::Uno::Generic__Equals__int4(NULL, a, b);
}
...
{
    return Matrix__Mul_10(NULL, Matrix__Mul_10(NULL, Matrix__Scaling_2(NULL, scale), Matrix__RotationQuaternion(NULL, rotationQuaternion)), Matrix__Translation_1(NULL, translation));
}
