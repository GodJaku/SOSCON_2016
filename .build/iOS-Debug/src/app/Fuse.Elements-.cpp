...
// This file was generated based on '/usr/local/share/uno/Packages/Fuse.Elements/0.11.3/$.uno'.
...
// This file was generated based on '/usr/local/share/uno/Packages/Fuse.Elements/0.11.3/Caching/$.uno'.
// WARNING: Changes might be lost if you edit this file directly.
...
void CacheHelper__init_DrawCalls(CacheHelper* __this)
{
    ...
    __this->_draw_934926a0 = ::app::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall__New_1(NULL, ::uCast< ::app::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram*>(::app::Uno::Runtime::Implementation::Internal::BundleRegistry__Get(NULL, 86), ::app::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram__typeof()));
}
...
{
    __this->_draw_3bd224e1 = ::app::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall__New_1(NULL, ::uCast< ::app::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram*>(::app::Uno::Runtime::Implementation::Internal::BundleRegistry__Get(NULL, 87), ::app::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram__typeof()));
}
...
void ElementBatcher__UpdateDrawList(ElementBatcher* __this)
{
    ...
    for (::app::Uno::Collections::List1_Enumerator__Fuse_Node enum_126 = ::uPtr< ::app::Uno::Collections::List__Fuse_Node*>(__this->_elements)->GetEnumerator(); enum_126.MoveNext(); )
    {
        ...
        if (emitNewBatch || (atlas == NULL))
        {
            ...
            {
                ::app::Uno::Diagnostics::Debug__Log_1(NULL, ::uGetConstString("BUG: atlas-insertion failed, but should not!"), 1, ::uGetConstString("/usr/local/share/uno/Packages/Fuse.Elements/0.11.3/Caching/$.uno"), 1058);
