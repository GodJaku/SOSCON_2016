...
bool Pointer__HardCapture(::uStatic* __this, int pointIndex, ::app::Fuse::Node* node, ::uObject* identity, ::uDelegate* lostCallback)
{
    ...
    {
        ::app::Uno::Diagnostics::Debug__Log_1(NULL, ::uGetConstString("HardCapture can only be done on rooted enabled node"), 1, ::uGetConstString("/usr/local/share/uno/Packages/FuseCore/0.11.3/Input/$.uno"), 1126);
        return false;
    }
...
bool Pointer__SoftCapture(::uStatic* __this, int pointIndex, ::app::Fuse::Node* softCapturer, ::uObject* identity, ::uDelegate* lostCallback)
{
    ...
    {
        ::app::Uno::Diagnostics::Debug__Log_1(NULL, ::uGetConstString("SoftCapture can only be done on rooted enabled node"), 1, ::uGetConstString("/usr/local/share/uno/Packages/FuseCore/0.11.3/Input/$.uno"), 1035);
        return false;
    }
